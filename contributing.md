...
-   clone the repository by running `git clone https://github.com/IamSebastianDev/create-nord.git` in your terminal or shell to clone the repo into the current directory.
